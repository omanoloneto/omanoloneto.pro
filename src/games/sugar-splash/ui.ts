...
export function criarUI(ctx: Contexto): UI {
  ...
  const els = {
    ...
    hudTop: $('[data-hud-top]'),
    roomSep: $('[data-room-sep]'),
    roomCode: $('[data-room-code]'),
    teamBadge: $('[data-team-badge]'),
    scoreboard: $('[data-scoreboard]'),
    scoreboardList: $('[data-scoreboard-list]'),
    ...
    votoRow: $('[data-voto-row]'),
    votoTrocar: $('[data-voto-trocar]'),
    votoFicar: $('[data-voto-ficar]'),
